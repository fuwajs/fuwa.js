...
import { CommandOptions, CommandOptionTypes } from '../interfaces/index.ts';
import { ArgumentConverter } from '../lib/structures/handlers/Command.ts';
import Globs from './Global.ts';
