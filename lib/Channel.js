        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        result = _a.sent();
                        c = result.data.map(function (channel) { return new _Channel_1.Channel(channel).getObj(); });
                        return [2 /*return*/, c];
                    case 3:
                        e_1 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        channels = _a.sent();
                        return [2 /*return*/, channels.filter(function (channel) { return channel.id === channelid; })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        channels = _a.sent();
                        return [2 /*return*/, channels.filter(condition)];
                    case 2: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        channels = _a.sent();
                        return [2 /*return*/, channels.find(condition)];
                    case 2: return [2 /*return*/];
                }
            });
        });
