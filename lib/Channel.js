        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, axios_1.default(_Const_1.discordAPI.api + "/guilds/" + guild + "/channels", { method: "GET", headers: { "Authorization": "Bot " + this.token } })];
                    case 2:
                        result = _a.sent();
                        c = result.data.map(function (channel) { return new _Channel_1.Channel(channel, _this.token).getObj(); });
                        return [2 /*return*/, c];
                    case 3:
                        e_1 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, axios_1.default(_Const_1.discordAPI.api + "/guilds/" + guild + "/channels", { method: "POST", headers: { "Authorization": "Bot " + this.token }, data: data })];
                    case 2:
                        result = _a.sent();
                        c = new _Channel_1.Channel(result.data, this.token).getObj();
                        return [2 /*return*/, c];
                    case 3:
                        e_2 = _a.sent();
