...
var Channel = /** @class */ (function () {
    function Channel(data, token) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, axios_1.default(_Const_1.discordAPI.api + "/channels/" + this.object.id, { method: "PATCH", headers: { "Authorization": "Bot " + this.token }, data: data })];
                        case 2:
                            c = _a.sent();
                            channel = new Channel(c.data, this.token);
                            return [2 /*return*/, channel];
                        case 3:
                            e_1 = _a.sent();
                            return [2 /*return*/, e_1.response.data.errors.parent_id._errors];
        ...
        this.object.delete = function () { return __awaiter(_this, void 0, void 0, function () {
            var result, channel, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default(_Const_1.discordAPI.api + "/channels/" + this.object.id, { method: "DELETE", headers: { "Authorization": "Bot " + this.token } })];
                    case 1:
                        result = _a.sent();
                        channel = new Channel(result.data, this.token);
                        return [2 /*return*/, channel];
                    case 2:
                        e_2 = _a.sent();
