        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                            ...
                            Object.keys(content).map(function (el) {
                                if (el === "color") {
                                    ...
                                    if (typeof content.color === "string") {
                                        var colorcode = content.color ? 0 + "x" + content.color.split("#")[1] : '0';
                                        colorcode !== '0' ? content.color = parseInt(colorcode) : content.color = content.color;
                                    }
                                    ;
                                }
                                ;
                                (_this.data.embed = content), (_this.data.tts = false), (_this.data.content = "<@" + _this.req.author.id + "> ");
                            });
                        }
                        ;
                        ...
                        if (embed) {
                            Object.keys(embed).map(function (el) {
                                ...
                                if (el == "color" && typeof embed.color === "string") {
                                    var colorcode = embed.color ? 0 + "x" + embed.color.split("#")[1] : "0";
                                    if (colorcode !== "0") {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, axios_1.default("https://discord.com/api/v8/channels/" + this.req.channel_id + "/messages", {
                                method: "POST",
                                headers: {
