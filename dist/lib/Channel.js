...
//         let sortedChannels = channels.map((channel) =>
//             new _Channel(channel, this.token).getObj()
//         );
...
//             ? (data.permission_overwrites = obj.permissionOverwrites)
//             : 0;
//         let d = JSON.stringify(data);
//         let channel: any = await uncidiOther(
//             'POST',
//             `/api/v8/guilds/${guild}/channels`,
//             this.token,
//             d
//         );
